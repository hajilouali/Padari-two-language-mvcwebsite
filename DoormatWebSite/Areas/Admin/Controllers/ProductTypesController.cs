...
namespace DoormatWebSite.Areas.Admin.Controllers
{
    public class ProductTypesController : Controller
    {
        ...
        {
            var productType = db.ProductType.Include(p => p.languageType);
        ...
        public ActionResult Create([Bind(Include = "ProductTypeId,Title,Lanid")] ProductType productType)
        {
            ...
            ViewBag.Lanid = new SelectList(db.languageType, "Lanid", "Type", productType.Lanid);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductTypeId,Title,Lanid")] ProductType productType)
        {
            if (ModelState.IsValid)
            {
